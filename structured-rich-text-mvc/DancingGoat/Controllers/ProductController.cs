...
namespace DancingGoat.Controllers
{
    public class ProductController : ControllerBase
    {
        ...
        {
            var item = (await client.GetItemsAsync<object>(new EqualsFilter("elements.url_pattern", urlSlug), new InFilter("system.type", "brewer", "coffee", "accessory"))).Items.FirstOrDefault();
